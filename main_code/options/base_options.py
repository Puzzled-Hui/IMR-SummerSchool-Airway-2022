...
class BaseOptions():
    ...
    def initialize(self, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='F:\\important_data\\LIDC_50-20_V1.0',
                            help='path to images')
        parser.add_argument('--name', type=str, default='Baseline-Airway-Segmentation',
                            help='the name of the experiment, e.g., Baseline-Airway-Segmentation')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0,1,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str,
                            default="F:\important_code\\Airway-SummerSchool-2022\\main_code\\checkpoints_models\\Airway",
                            help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='unet3d',
                            help='chooses which model to use. [unet3d|etc..]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='airway',
                            help='chooses how datasets are loaded. e.g., airway')
        ...
        parser.add_argument('--suffix', default='v1_20220711', type=str,
