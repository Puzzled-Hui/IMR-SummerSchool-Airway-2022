...
'''
Program :   1. Options for the training procedure.
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        ## --n_epochs and n_epochs_dacay havenot used for the moment.
        parser.add_argument('--n_epochs', type=int, default=100, help='number of epochs with the initial learning rate')
        parser.add_argument('--n_epochs_decay', type=int, default=100,
                            help='number of epochs to linearly decay learning rate to zero')
        parser.add_argument('--lr_decay_iters', type=str, default='1000',
        ...
        parser.add_argument('--adam_beta1', type=float, default=0.9, help='beta1 of Adam')
        parser.add_argument('--loss_mode', type=str, default='Dice', help='Dice,etc')
        parser.add_argument('--total_epoch', type=int, default=1200, help='how many epochs to train')
