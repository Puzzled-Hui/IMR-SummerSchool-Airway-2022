...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        #     now = time.strftime("%c")
        #     log_file.write('================ Epoch Test Metric (%s) ================\n' % now)
        #
        # self.epoch_train_metric = os.path.join(opt.checkpoints_dir, opt.name, 'epoch_train_metric.txt')
        # with open(self.epoch_test_metric, "a") as log_file:
        #     now = time.strftime("%c")
        #     log_file.write('================ Epoch Train Metric (%s) ================\n' % now)
